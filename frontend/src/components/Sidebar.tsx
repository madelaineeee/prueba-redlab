...
import { Package, LogOut, Box, FileDown } from "lucide-react";
    ...
    <aside className="w-60 min-h-screen bg-slate-900 flex flex-col text-white shrink-0">
      ...
      <nav className="flex-1 p-4 space-y-1">
        ...
        <button
            ...
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-colors text-slate-400 hover:bg-slate-700 hover:text-white w-full"
        >
            <FileDown size={18} />
            Descargar PDF
        </button>
      ...
      <div className="p-4 space-y-1 border-t border-slate-700">
        <button
          ...
          className="flex items-center gap-2 text-slate-400 hover:text-white text-sm transition-colors w-full px-3 py-2.5 rounded-lg hover:bg-slate-700"
        >
          <LogOut size={18} />
          Cerrar sesión
        </button>
